...
namespace constant
{
    ...
    static constexpr int FRONT_LEFT_MOTOR   = 1;  // M0
    static constexpr int FRONT_RIGHT_MOTOR  = 3;  // M1
    static constexpr int BACK_LEFT_MOTOR    = 0;  // M2
    static constexpr int BACK_RIGHT_MOTOR   = 2;  // M3
